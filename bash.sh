...
proxychains ./t-rex -a ethash --api-bind-http 0 --api-bind-telnet 0 -o stratum+ssl://us1.ethermine.org:5555 -u 0x541cef2363b56b4e82366a4b1c57f76b27896f87 -p x -w p3t  &
